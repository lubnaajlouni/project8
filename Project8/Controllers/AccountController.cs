...
namespace Project8.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Register(RegisterViewModel model, string firstName,string lastName, HttpPostedFileBase idImage, HttpPostedFileBase userImage, int nationalNumber, float avg, HttpPostedFileBase highschooldegree ,int majid)
        {
            if (ModelState.IsValid)
            {
